...
export const certificatesList: CertificateItem[] = [
  ...
  },
  {
    ...
    details: {
      ...
      skillsVerified: [
        "State Level Medal Winner",
        "Competitive Bodybuilding Category",
        "Peak Muscular Symmetry & Aesthetics",
        "Competition Prep & Peak Week Mentorship",
      ],
      description:
        "State Level Merit Certificate awarded to Mr. Girish Shapurkar at the Karnataka Shbee State Level Bodybuilding Competition 2023.",
      sealText: "STATE MERIT",
    },
  },
  {
    id: "cert-3",
    title: "All India Inter-University Powerlifting Championship",
    ...
    details: {
      coachName: "Mr. Girish Shapurkar",
      coachTitle: "Founder & Head Coach",
      certificateTitle: "ALL INDIA INTER-UNIVERSITY POWERLIFTING 2018-19",
      issuer: "Association of Indian Universities & Calicut University",
      issueYear: "2019 — ALL INDIA PARTICIPANT",
      certId: "HERC-CERT-2019-03",
      skillsVerified: [
        "Heavy Squat, Bench Press & Deadlift Technique",
        "National Level Powerlifting Competition",
        "Maximal Strength Programming",
        "CNS Fatigue Management",
      ],
      description:
        "Official Certificate of Participation awarded to Girish Shapurkar representing Gulbarga University at the All India Inter-University Powerlifting Championship held at University of Calicut.",
      sealText: "ALL INDIA ATHLETE",
    },
  },
  {
    id: "cert-4",
    title: "All India Inter-University Best Physique Competition",
    ...
    details: {
      coachName: "Mr. Girish Shapurkar",
      coachTitle: "Founder & Head Coach",
      certificateTitle: "ALL INDIA BEST PHYSIQUE CHAMPIONSHIP 2019-20",
      issuer: "Association of Indian Universities & Chandigarh University",
      issueYear: "2020 — NATIONAL ATHLETE",
      certId: "HERC-CERT-2020-04",
      skillsVerified: [
        "National Level Physique Aesthetics",
        "Surgical Muscle Hypertrophy Protocols",
        "Stage Posing & Muscular Symmetry",
        "Elite Conditioning & Body Recomposition",
      ],
      description:
        "Official Certificate of Merit & Participation awarded to Girish Shapurkar representing Gulbarga University at the All India Inter-University Best Physique Championship held at Chandigarh University.",
      sealText: "NATIONAL PHYSIQUE",
    },
  },
  {
    id: "cert-5",
    title: "Hydra Open Men's Physique Championship",
